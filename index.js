...
<li class="card-txt-item"><p class="card-txt">downloads <br/>${h}</p></li>
  ...
  </li>`).join("");o.insertAdjacentHTML("beforeend",r),m.refresh(),m.on("show.simplelightbox",()=>{})}const d=document.querySelector(".form"),P=document.querySelector("input[type=text]"),c=document.querySelector(".btn-load-more");let u=1,n=null;const p=async(s,r)=>{try{const a=await b(s,r);if(a.totalHits===0)throw new Error;w(a.hits);const i=Math.ceil(a.totalHits/15);r===i&&(c.classList.add("visually-hidden"),y.show({position:"topRight",message:`Sorry, there are no images matching your search query. Please try again!
